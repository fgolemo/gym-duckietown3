...
## straight
road_pos = [0, 0, 0]
road_orientation = p.getQuaternionFromEuler([0, 0, 0])
road_id = p.loadURDF("../assets/urdf/road/road_plain.urdf", road_pos, road_orientation)

## turn
road_pos = [0, 2, 0]
road_orientation = p.getQuaternionFromEuler([0, 0, np.deg2rad(90)])
road_id = p.loadURDF("../assets/urdf/road/road_turn.urdf", road_pos, road_orientation)
